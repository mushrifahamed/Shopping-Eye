      ...
      <nav>
        <ul>
          ...
          <li className="mb-2">
            <Link
              to="/register"
              className={`block py-2 px-4 rounded flex items-center ${isActive('/register') ? 'bg-blue-600 text-white hover:bg-blue-500' : 'hover:bg-blue-500 hover:text-white text-black'}`}
            >
